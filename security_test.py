...
fake_users_db = {
    "anmar": {
        ...
        "hashed_password": "$2b$12$yhpjywOCTRGtKzUCxghcdOl1BIEb7vcfeg6QQz9No5asm0cpLRUFq",
        "disabled": False,
    },"nemo": {
        "username": "nemo",
        "full_name": "John Doe",
...
#onlu useable if im building a pure api without frontend
...
# #the response model is not needed i already declared the response on the endpoint
...
pwd=get_password_hash("anmar2020")
print(pwd)